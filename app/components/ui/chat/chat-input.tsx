...
export default function ChatInput(
  ...
  const exampleMessages = [
    {
      heading: "What is",
      subheading: "Procurement Procedures Manual?",
      message: `What is Procurement Procedures Manual ?`
    },
    {
      heading: "What are",
      subheading: "Direct Charge Items?",
      message: `What are direct charge items?`
    },
    {
      heading: "What are",
      subheading: "Procurement Objectives?",
      message: "What are Procurement Objectives ?"
    },
    {
      heading: "What to do",
      subheading: "if no explicit guideline available in PPM?",
      message: `what to do in case there is no explicit guideline available in the PPM?`
    },
  ];
